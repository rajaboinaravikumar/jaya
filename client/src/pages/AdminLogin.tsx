    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12 bg-muted/30">
        <Card className="w-full max-w-md p-8">
          ...
          <h1 className="text-2xl font-bold text-center mb-2" data-testid="text-page-title">Admin Portal</h1>
          <p className="text-center text-muted-foreground mb-8" data-testid="text-page-subtitle">
            Sign in with administrative credentials
          </p>
          
          <Button onClick={handleLogin} className="w-full" data-testid="button-admin-login-submit">
            Sign In with Replit
          </Button>
